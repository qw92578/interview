...
(function($) {
						...
						if(s.get(0)
							...
							if(n.changeInput) {
								switch(typeof n.changeInput) {
									case "boolean":
										o = $('<div class="jFiler-input"><div class="jFiler-input-button addObjBtn upload-btn"><i class="fa fa-upload" style="margin-right: 5px"></i>' + n.captions.button + '</div></div>"');
										break;
									case "string":
									case "object":
										o = $(n.changeInput);
						...
						generateIcon: function(obj) {
							...
							if(obj && obj.type && obj.extension) {
								switch(obj.type) {
                                   ...
                                   /* case "word":
                                        m[0] = "f-word";
                                        m[1] = "<i class=\"icon-jfi-file-word\"></i>"
                                        break;
                                    case "excel":
                                        m[0] = "f-excel";
                                        m[1] = "<i class=\"icon-jfi-file-excel\"></i>"
                                        break;*/
									// 	add by yk
									default:
	...
	$.fn.filer.defaults = {
		...
		templates: {
			...
			item: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-icon}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title" title="{{fi-name}}">{{fi-name | limitTo:22}}</div><div class="jFiler-item-others"><span class="jFiler-item-others-size">大小: {{fi-size2}}</span><span class="jFiler-item-others-type">类型: {{fi-extension}}</span><span class="jFiler-item-status">{{fi-progressBar}}</span></div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
			itemAppend: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-icon}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title">{{fi-name | limitTo:35}}</div><div class="jFiler-item-others"><span>大小: {{fi-size2}}</span><span>类型: {{fi-extension}}</span><span class="jFiler-item-status"></span></div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
